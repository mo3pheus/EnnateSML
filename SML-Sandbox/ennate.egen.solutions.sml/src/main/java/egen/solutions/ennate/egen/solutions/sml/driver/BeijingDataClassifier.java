...
public class BeijingDataClassifier {

	public static void main(String[] args) {
		SanketML beijingClassfier = new SanketML();
		
		// Read from 10 files and classify each
		int i = 1;
		while(i <= 10) {
			try {
				beijingClassfier.loadGeoData("geodata-" + i + ".plt", ",", 2);
				int numClusters = (int) Math.round(beijingClassfier.getTotalDistance() * 8);
				
				System.out.println("\n\n\n ############################  CLUSTERING  ###################################\n\n ");
				try {
					Map<Data, List<Data>> clusters = KesavaUtil.evaluateGeoKClusterWithNClusters(2, beijingClassfier, new Random(), numClusters);
				} catch (Exception e) {
					e.printStackTrace();
...
//		beijingClassfier.populateTrainTestSets(80);
//
//		System.out.println(" Number of training samples = " + beijingClassfier.getTrainingData().size());
//		System.out.println(" Number of testing samples = " + beijingClassfier.getTestingData().size());
//
//		/*
...
//		classificationEngine.buildModels(beijingClassfier.getTrainingData(), 4);
//		classificationEngine.buildModelsV2(beijingClassfier.getTrainingData(), 4);
//    
...
//		beijingClassfier.setClassificationEngine(classificationEngine);
//		System.out.println("Accuracy Percentage = " + beijingClassfier.getAccuracy() + " % ");
//		System.out.println("Accuracy Percentage of Version 2= " + beijingClassfier.getAccuracyV2() + " % ");
//
//		/*
...
//		try {
//			Map<Data, ClusteredPoints> result = clusterer.clusterData(beijingClassfier.getTrainingData(), numClusters);
//			beijingClassfier.setClusterer(clusterer);
//
...
//
//			System.out.println(
//					" For number of clusters = " + numClusters + " Cost = " + beijingClassfier.getCostFunction(result));
//
//		} catch (Exception e) {
//			e.printStackTrace();
//			System.out.println("Exception in clustering data!");
